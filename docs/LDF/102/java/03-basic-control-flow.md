...
Find all the control flow nodes and their successors by implementing exercises/Exercise1.ql.
...
A solution can be found in the query solutions/Exercise1.ql.
...
Implement the _predicate_ `reachable` using the successor relationship by completing the query exercises/Exercise2.ql.
...
A solution can be found in the query solutions/Exercise2.ql.

#### Exercise 3

To visualize the intra-procedural CFG, that is the CFG of a method not crossing method boundaries, restrict the begin node and the reachable node by completing the query in  exercises/Exercise3.ql.
...
A solution can be found in the query solutions/Exercise3.ql.
